...
- Primeiro palestrante confirmado (DEC-017, 23/09): Coatio respondeu ao questionário fora do prazo e antes do VIRUS. Tema corrigido para os bastidores da construção do Caranga, com demonstração do piloto, e nome público "Matheus Coatio". Respostas registradas em `docs/evento/RESPOSTAS_PALESTRANTES.md`; peça 4 escrita para sair antes da peça 3, sem numerar a palestra; foto tratada em p&b e recorte 4:5. Aba Comunicação com 37 peças. Bloqueios: aval do Coatio ao título curto e à foto, confirmação dos prazos de 28/09 e 03/10, e o questionário do VIRUS, atrasado desde 21/09.
