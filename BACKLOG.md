...
- Gestão contínua (DEC-012, desde 14/09): AI-002 cobre a gestão até o fechamento do evento; cada rodada termina em READY_FOR_REVIEW. Rodada de 14/09: formulários online documentados em `docs/evento/FORMULARIOS.md`, aguardando aprovação; Checklist com 38 tarefas.
