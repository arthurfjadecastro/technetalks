...
- Falta: revisão de Arthur e Henrique; registrar em DECISIONS o que a reunião fechar (preparo, menu, limites por categoria, apoio, tempos das palestras, moderador, foto) e refletir no plano e na planilha. Commit/push aguarda autorização explícita, porque DEC-006 cobre só arquivos locais.
...
- Git: base em b38ce1d; todas as mudanças de AI-002 estão no working tree, sem commit.
