...
- Git: entrega publicada em `origin/main` (a1640a1, 462940a), conferida por `git ls-remote`, seguida pelo commit deste registro. Um clone novo recebe todo o trabalho. Neste Mac a credencial do GitHub (conta arthurfjadecastro) está no Keychain, usada pelo helper `osxkeychain`.
